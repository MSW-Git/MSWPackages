...
This package is a UI resource pack collected from Maple Duel, an original world.
It provides UI Models (buttons, panels, etc.) and a range of sample UI screens, allowing creators to quickly assemble polished in-game interfaces by referencing or adapting the included assets.
