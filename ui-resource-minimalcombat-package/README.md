...
This package is a UI resource pack collected from Maple Auto Battler, an original world.
It provides UI Models (icons) allowing creators to quickly assemble polished in-game interfaces by referencing or adapting the included assets.
...
Includes Icons, Tints, and so on.
