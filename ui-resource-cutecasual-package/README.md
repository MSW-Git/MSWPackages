...
This package is a UI resource pack collected from ChuChuBurger, an original world.
...
Includes Buttons, Panels, Icons, Resources, Slots, Sliders, Backgrounds, Tints, and decorative units.
